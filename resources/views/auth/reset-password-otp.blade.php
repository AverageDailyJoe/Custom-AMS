...
<body class="bg-[#09090b] text-zinc-100 flex items-center justify-center min-h-screen p-4 antialiased">
    <div class="w-full max-w-md bg-[#18181b] border border-zinc-800 rounded-2xl p-8 shadow-2xl">
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-[#15803d] hover:bg-[#166534] text-white font-medium py-2.5 rounded-lg text-sm transition duration-200 shadow-lg shadow-emerald-950/40">Perbarui Password</button>
        </form>
    </div>
